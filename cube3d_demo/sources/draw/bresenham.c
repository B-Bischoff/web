...
static void	plot_line_high(t_data *data, t_vector2_d p1, t_vector2_d p2, int color);
static void	plot_line_low(t_data *data, t_vector2_d p1, t_vector2_d p2, int color);
